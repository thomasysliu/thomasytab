// ==UserScript==
// @include https://regist.nctu.edu.tw/*
// @include http://regist.nctu.edu.tw/*
// @include https://cos.adm.nctu.edu.tw/*
// @include http://cos.adm.nctu.edu.tw/*
// @include http://portal.nctu.edu.tw/*
// @include https://portal.nctu.edu.tw/*
// ==/UserScript==
window.addEventListener('DOMContentLoaded', function () {

    // Specify the path to the stylesheet here:
    var path = 'styles/cos.css';
